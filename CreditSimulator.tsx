...
import { Info, Calculator, ArrowRightLeft, TrendingDown, DollarSign, Scale, Percent } from 'lucide-react';
                      ...
                      <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 min-w-[150px]">
                        ...
                        <div className="space-y-1.5">
                          <div className="flex justify-between text-xs">
                            ...
                            <span className="font-black text-slate-800 dark:text-white">R$ {(payload[0].value! + payload[1].value!).toLocaleString('pt-BR')}</span>
                          </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-[2rem] border border-blue-100 dark:border-blue-900/30 flex gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-blue-800 dark:text-blue-200/70 leading-relaxed font-medium">
              No Sistema de Amortização Constante, você paga uma parte fixa da dívida todos os meses. Como o saldo devedor cai mais rápido, o valor dos juros (que incide sobre o saldo) também cai rapidamente, gerando parcelas decrescentes.
            </p>
          </div>
        </div>
        <div className="bg-indigo-50 dark:bg-indigo-900/10 p-6 rounded-[2rem] border border-indigo-100 dark:border-indigo-900/30 flex gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-indigo-800 dark:text-indigo-200/70 leading-relaxed font-medium">
              A Tabela Price mantém o valor da parcela fixo. No início, a maior parte da parcela é juros e pouco é amortização. Isso faz com que a dívida demore mais para cair, resultando em um custo total de juros maior que o SAC.
            </p>
          </div>
        </div>
      </div>
